...
export const projects = [
  {
    ...
    color: 'indigo',
    filter: ['ai', 'saas'],
    badge: '📄 Doc Intelligence · AI Extraction',
    status: 'dev',
    statusLabel: 'In Development',
    title: 'DATAVORE — Document Intelligence Platform',
    stack: 'Next.js 16 · FastAPI · PostgreSQL · LiteLLM · Claude/GPT-4/Ollama · Tesseract OCR · Framer Motion',
    impact: 'End-to-end AI document extraction — ingest any format, extract structured data, review & export',
    bullets: [
      'Provider-agnostic AI layer (Claude, GPT-4, Ollama via LiteLLM) with per-field confidence scoring',
      'Handles text PDFs, scanned PDFs (OCR), DOCX, images — Google Drive & SharePoint auto-sync',
      'Human-in-the-loop review UI: corrections stored as few-shot examples to improve future extractions',
      'Multi-tenant RBAC (50 seats), ephemeral data lifecycle, colour-coded Excel export',
    ],
    link: '#',
  },
  {
